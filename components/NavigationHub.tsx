    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <>
          ...
          {/* Navigation Hub */}
          <motion.div 
            className="fixed inset-0 z-[50] overflow-visible flex flex-col"
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex items-center justify-between lg:justify-start gap-3">
              ...
              <div className="flex items-center gap-2 lg:hidden">
                <button
                  ...
                  className="p-2 text-white/70 hover:text-white border border-white/20 rounded hover:border-white/40 transition-colors"
                >
            ...
            <div className="hidden lg:flex items-center gap-3">
              <button
                ...
                className="px-3 py-1 text-sm text-white/70 hover:text-white border border-white/20 rounded hover:border-white/40 transition-colors"
              >
                Legend
              </button>
              <button
